...
public class serate {
    ...
    static void help(int html) {
        ...
        System.err.println("  input puzzles.  If an --input=FILE option is specified then 256-character puzzle");
        System.err.println("  strings are read from that file, otherwise if 256-character puzzle operands are");
        ...
        System.err.println("        %g  The puzzle grid in 256-character [0-9] form.");
        ...
        System.err.println("      Read 256-character puzzle strings, one per line, from FILE.  By default");
        System.err.println("      operands are treated as 256-character puzzle strings.  If no operands are");
