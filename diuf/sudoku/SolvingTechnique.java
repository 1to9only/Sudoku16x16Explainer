...
public enum SolvingTechnique {
    ...
    XYWing("XY-Wing"),
    DirectHiddenQuad("Direct Hidden Quad"),
    XYZWing("XYZ-Wing"),
    UniqueLoop("Unique Rectangle / Loop"),
    NakedQuad("Naked Quad"),
    NakedQuintuplet("Naked Quintuplet"),
    NakedSextuplet("Naked Sextuplet"),
    NakedSeptuplet("Naked Septuplet"),
    Jellyfish("Jellyfish"),
    Starfish("Starfish"),
    Whale("Whale"),
    Leviathan("Leviathan"),
    HiddenQuad("Hidden Quad"),
    HiddenQuintuplet("Hidden Quintuplet"),
    HiddenSextuplet("Hidden Sextuplet"),
    HiddenSeptuplet("Hidden Septuplet"),
